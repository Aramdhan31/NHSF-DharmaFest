...
export const metadata: Metadata = {
  ...
  description:
    "DharmaFest 2026 — Your Story, On Stage. National showcase for culture and identity through the creative arts. Sunday 8 March 2026 at The Bhavan, London. Featuring classical and contemporary Indian arts including Kathak, Bharatnatyam, Carnatic music, and more.",
  keywords: [
    "DharmaFest",
    "DharmaFest 2026",
    "NHSF UK",
